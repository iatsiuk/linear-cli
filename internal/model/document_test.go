...
func TestDocumentConnectionDeserialization(t *testing.T) {
	t.Parallel()
		...
		"nodes": [
			{
				...
				"title": "Doc A",
				"slugId": "doc-a",
				"url": "https://linear.app/team/doc/doc-a",
				"createdAt": "2026-01-01T00:00:00.000Z",
				"updatedAt": "2026-01-01T00:00:00.000Z"
			},
			{
				...
				"title": "Doc B",
				"slugId": "doc-b",
				"url": "https://linear.app/team/doc/doc-b",
	...
	if conn.Nodes[0].Title != "Doc A" {
		t.Errorf("Nodes[0].Title: got %q", conn.Nodes[0].Title)
	}
	if conn.Nodes[1].Title != "Doc B" {
